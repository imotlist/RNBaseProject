...
export interface TextFieldProps extends Omit<TextInputProps, "ref"> {
  ...
  /**
   * Size variation of the input.
   */
  size?: InputSize
  /**
   * Rounded variation of the input.
   */
...
export const TextField = forwardRef(function TextField(props: TextFieldProps, ref: Ref<TextInput>) {
  ...
  // Get rounded styles
  const $roundedStyle = rounded ? themed($inputRoundedStyles[rounded]) : themed($defaultInputRoundedStyle)
...
// Size variations for TextField
const $sizeStyles: Record<InputSize, ThemedStyle<ViewStyle>> = {
  small: ({ spacing }) => ({
    minHeight: scale(36),
  }),
  medium: ({ spacing }) => ({
...
// Rounded variations for TextField
const $inputRoundedStyles: Record<InputRounded, ThemedStyle<ViewStyle>> = {
  none: () => ({ borderRadius: 0 }),
...
const $defaultInputRoundedStyle: ThemedStyle<ViewStyle> = () => ({ borderRadius: moderateScale(4) })
