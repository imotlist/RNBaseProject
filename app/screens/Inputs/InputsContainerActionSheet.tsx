/**
 * InputsActionSheet.tsx
 *
 * Menu/Action sheet component for Inputs container screen.
...
export interface InputsActionSheetProps {
  selectedData: InputsData | null
  onClose: () => void
  onAction: (action: string, data?: InputsData) => void
}
...
export const InputsActionSheet: React.FC<InputsActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
