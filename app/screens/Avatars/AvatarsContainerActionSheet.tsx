/**
 * AvatarsActionSheet.tsx
 *
 * Menu/Action sheet component for Avatars container screen.
...
export interface AvatarsActionSheetProps {
  selectedData: AvatarsData | null
  onClose: () => void
  onAction: (action: string, data?: AvatarsData) => void
}
...
export const AvatarsActionSheet: React.FC<AvatarsActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
