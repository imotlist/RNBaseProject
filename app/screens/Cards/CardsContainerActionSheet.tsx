/**
 * CardsActionSheet.tsx
 *
 * Menu/Action sheet component for Cards container screen.
...
export interface CardsActionSheetProps {
  selectedData: CardsData | null
  onClose: () => void
  onAction: (action: string, data?: CardsData) => void
}
...
export const CardsActionSheet: React.FC<CardsActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
