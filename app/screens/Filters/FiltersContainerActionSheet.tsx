/**
 * FiltersActionSheet.tsx
 *
 * Menu/Action sheet component for Filters container screen.
...
export interface FiltersActionSheetProps {
  selectedData: FiltersData | null
  onClose: () => void
  onAction: (action: string, data?: FiltersData) => void
}
...
export const FiltersActionSheet: React.FC<FiltersActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
