/**
 * TogglesActionSheet.tsx
 *
 * Menu/Action sheet component for Toggles container screen.
...
export interface TogglesActionSheetProps {
  selectedData: TogglesData | null
  onClose: () => void
  onAction: (action: string, data?: TogglesData) => void
}
...
export const TogglesActionSheet: React.FC<TogglesActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
