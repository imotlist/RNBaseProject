/**
 * DataItemsFilterSheet.tsx
 *
 * Filter bottom sheet component for DataItems list screen.
...
export interface DataItemsFilterSheetProps {
...
export const DataItemsFilterSheet: React.FC<DataItemsFilterSheetProps> = ({
  filters,
  setFilters,
  onClose,
}) => {
