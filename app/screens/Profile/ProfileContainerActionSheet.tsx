/**
 * ProfileActionSheet.tsx
 *
 * Menu/Action sheet component for Profile container screen.
...
export interface ProfileActionSheetProps {
  ...
  onClose: () => void
  onAction: (action: string, data?: ProfileData) => void
}
...
export const ProfileActionSheet: React.FC<ProfileActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
