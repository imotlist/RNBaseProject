/**
 * ListsFilterSheet.tsx
 *
 * Filter bottom sheet component for Lists list screen.
...
export interface ListsFilterSheetProps {
...
export const ListsFilterSheet: React.FC<ListsFilterSheetProps> = ({
  filters,
  setFilters,
  onClose,
}) => {
