/**
 * ProfileEditActionSheet.tsx
 *
 * Menu/Action sheet component for ProfileEdit container screen.
...
export interface ProfileEditActionSheetProps {
  selectedData: ProfileEditData | null
  onClose: () => void
  onAction: (action: string, data?: ProfileEditData) => void
}
...
export const ProfileEditActionSheet: React.FC<ProfileEditActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
