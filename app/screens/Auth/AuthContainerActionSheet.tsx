 ...
 * AuthActionSheet.tsx
 *
 * Menu/Action sheet component for Auth container screen.
...
export interface AuthActionSheetProps {
  selectedData: AuthData | null
  onClose: () => void
  onAction: (action: string, data?: AuthData) => void
}
...
export const AuthActionSheet: React.FC<AuthActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
