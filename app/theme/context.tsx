...
// Custom navigation theme with solid tab bar background for light mode
const NavDefaultTheme: NavTheme = {
  ...NavigationDefaultTheme,
  colors: {
    ...NavigationDefaultTheme.colors,
    primary: lightTheme.colors.tint,
    background: lightTheme.colors.palette.neutral100,
    card: lightTheme.colors.palette.neutral100,
    border: lightTheme.colors.separator,
    text: lightTheme.colors.text,
    notification: lightTheme.colors.tint,
  },
}

// Custom navigation theme with solid tab bar background for dark mode
const NavDarkTheme: NavTheme = {
  ...NavigationDarkTheme,
  colors: {
    ...NavigationDarkTheme.colors,
    primary: darkTheme.colors.tint,
    background: darkTheme.colors.palette.neutral100,
    card: darkTheme.colors.palette.neutral100,
    border: darkTheme.colors.separator,
    text: darkTheme.colors.text,
    notification: darkTheme.colors.tint,
  },
}
