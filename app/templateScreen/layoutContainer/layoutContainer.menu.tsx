/**
 * {{FEATURE_NAME_PASCAL}}ActionSheet.tsx
 *
 * Menu/Action sheet component for {{FEATURE_NAME}} container screen.
...
export interface {{FEATURE_NAME_PASCAL}}ActionSheetProps {
...
export const {{FEATURE_NAME_PASCAL}}ActionSheet: React.FC<{{FEATURE_NAME_PASCAL}}ActionSheetProps> = ({
  selectedData,
  onClose,
  onAction,
}) => {
